...
if __name__ == "__main__":
    ...
    vetoes =                [4000.00, 10.00, 2.00, 6.30, 4.50, 120.00, 2.00]
    ...
    print("ELECTRE")
    res = e.solve(weights, prefs, vetoes, indifference_threshold, preference_thresholds)
    print(res)
    print("#"*50)
    
    print("PROMETHEE")
    res = pr.solve(weights=weights, prefs=prefs)
    print(res["phi"])
    print("#"*50)
    
    print("PARETO")
    res = pa.solve(indexes=criteria_idx, prefs=criteria_prefs)
    print(res)
    print("#"*50)
